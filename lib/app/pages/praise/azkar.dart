                ...
                Center(
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton2<String>(
                      ...
                      items: model.locNightPraiseslist
                          .map(
                ...
                Center(
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton2<String>(
                      ...
                      items: model.locMorningPraiseslist
                          .map(
                            (String item) => DropdownMenuItem<String>(
                              value: item,
                              child: Directionality(
...
//               //model.getLocpriase();
//               // other.clearAllPrefs();
//               //model.checkFoundPrefs('سبحان الله وبحمده سبحان الله العظيم');
//               showModalBottomSheet(
//                   shape: const RoundedRectangleBorder(
//                       borderRadius:
...
//                                                 //     model.praiseslist![1][1]);
//                                                 model.total = model
//                                                         .countlocNightPraiseslist[
//                                                     model.locNightPraiseslist
//                                                         .indexOf(item)];
...
//                                                   fontSize: 15,
//                                                   color: Colors.white),
//                                               "${model.countlocNightPraiseslist[model.locNightPraiseslist.indexOf(item)]}",
//                                               textAlign: TextAlign.center,
//                                             ))
//                                       ],
//                                     ),
...
//                                                   fontSize: 15,
//                                                   color: Colors.white),
//                                               "${model.countLocMorningPraiseslist[model.locMorningPraiseslist.indexOf(item)]}",
//                                               textAlign: TextAlign.center,
//                                             ))
//                                       ],
//                                     ),
...
//                           ),
//                           leading: Text(model.praiseslist![index][1],
//                               style: Theme.of(context).textTheme.displayLarge),
//                         ),
//                       ),
//                     );
